...
def compute_reward_weighted(
        ...
        aggressive_unclip, enable_sbc, dynamics, cost_enable_extra, no_sol_flag):
    ...
    def _step(self, action, sbc_data):
        ...
        if self.enable_sbc:
            reward, rew_info = compute_reward_weighted(
                ...
                dynamics=self.dynamics, cost_enable_extra=self.cost_enable_extra, no_sol_flag=no_sol_flag
            )
        else:
            reward, rew_info = compute_reward_weighted(
                goal=self.goal, cur_pos=self.dynamics.pos, rl_acc=action,
                ...
                dynamics=self.dynamics, cost_enable_extra=self.cost_enable_extra, no_sol_flag=False
            )
