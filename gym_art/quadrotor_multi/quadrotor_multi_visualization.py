...
class Quadrotor3DSceneMulti:
    ...
    def create_obstacles(self):
        import gym_art.quadrotor_multi.rendering3d as r3d
        for _ in self.obstacles.pos_arr:
            color = OBST_COLOR_3
            ...
            obstacle_transform = r3d.transform_and_color(
                np.eye(4), color, r3d.box(x=self.obstacles.size, y=self.obstacles.size, z=self.room_dims[2]))
