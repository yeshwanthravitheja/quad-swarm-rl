...
def make_quadrotor_env_multi(cfg, render_mode=None, **kwargs):
    ...
    env = QuadrotorEnvMulti(
        ...
        # SBC specific
        enable_sbc=cfg.quads_enable_sbc, enable_thrust=cfg.quads_enable_thrust,
        ...
        # Log
        experiment_name=cfg.experiment, sbc_only=cfg.quads_sbc_only
    )
    ...
    reward_shaping['quad_rewards']['no_sol'] = cfg.quads_cost_no_sol
