...
QUAD_BASELINE_CLI = (
    ...
    '--adaptive_stddev=False --with_vtrace=False --max_policy_lag=100000000 --rnn_size=16 --with_pbt=False '
    ...
    '--normalize_input=False --normalize_returns=False --reward_clip=10.0 --save_milestones_sec=10000'
)
