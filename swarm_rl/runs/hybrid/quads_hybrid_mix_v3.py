...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_cost_cbf_agg", [0.0, 0.5]),
        ("quads_max_obst_aggressive", [0.2, 1.0, 10.0]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # Obstacle
    '--quads_obst_density=0.8 --quads_obst_size=0.6 --quads_obst_gap=-1 '
    # Cost
    ...
    # SBC
    '--quads_enable_sbc=True --quads_sbc_radius=0.05 --quads_max_acc=4.0 --quads_max_room_aggressive=1.0 '
    ...
    '--wandb_group=hybrid_compare_baseline_v3'
)

_experiment = Experiment(
    "hybrid_compare_baseline_v3",
    OBSTACLE_MODEL_CLI,
