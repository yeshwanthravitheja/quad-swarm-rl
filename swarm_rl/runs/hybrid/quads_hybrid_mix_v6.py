...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_obst_size", [0.6, 0.85]),
        ("quads_cost_rl_sbc", [0.0]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_collision_reward=0.0 --quads_collision_smooth_max_penalty=0.0 --quads_obst_collision_reward=0.0 '
    # SBC
    ...
    '--wandb_group=hybrid_compare_baseline_remove_cost_col'
)

_experiment = Experiment(
    "hybrid_compare_baseline_remove_cost_rl_sbc",
    OBSTACLE_MODEL_CLI,
