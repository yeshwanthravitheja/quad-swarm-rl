...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_obst_density", [0.07, 0.15]),
        ("quads_sbc_boundary", [0.1, 0.2]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    # Obstacle
    '--quads_obst_size=1.0 --quads_obst_gap=0.0 --quads_obst_spawn_area 9 9 '
    # Cost
    '--quads_cost_rl_mellinger=0.0 --quads_cost_extra_rl_real=0.0 --quads_cost_rl_sbc=0.1 --quads_cost_cbf_agg=2.0 '
    '--quads_cost_act_change=0.0 --quads_cost_no_sol=0.0 '
    # SBC
    '--quads_enable_sbc=True --quads_sbc_radius=0.05 --quads_max_neighbor_aggressive=50.0 '
    '--quads_max_obst_aggressive=25.0 --quads_max_acc=4.0 --quads_max_room_aggressive=0.2 '
    ...
    '--wandb_group=hybrid_obst_triangle_dens_bound'
)

_experiment = Experiment(
    "hybrid_obst_triangle_dens_bound",
    OBSTACLE_MODEL_CLI,
