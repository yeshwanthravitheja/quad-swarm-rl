...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_obs_acc_his=False --quads_cost_enable_extra=True --train_for_env_steps=2000000000 '
    # Obstacle
    ...
    '--quads_obst_density_min=0.2 --quads_obst_density_max=0.8 --quads_obst_gap_min=0.12 --quads_obst_gap_max=0.28 '
    '--quads_obst_size=0.75 '
    # Annealing
    ...
    '--wandb_group=domain_random_thrust_v2'
)

_experiment = Experiment(
    "domain_random_thrust_v2",
    OBSTACLE_MODEL_CLI,
