...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_obst_size", [0.6, 0.7, 0.8, 0.85]),
    ]
)

OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    # Self
    ' --quads_num_agents=32 --quads_obs_repr=xyz_vxyz_R_omega_floor --quads_episode_duration=15.0 '
    ...
    '--quads_neighbor_range=2.0 --quads_obst_range=3.0 '
    ...
    '--wandb_group=hybrid_compare_baseline'
)

_experiment = Experiment(
    "hybrid_compare_baseline",
    OBSTACLE_MODEL_CLI,
