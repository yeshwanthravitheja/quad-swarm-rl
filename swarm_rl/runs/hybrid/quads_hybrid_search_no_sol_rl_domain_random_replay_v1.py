...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("replay_buffer_sample_prob", [0.75, 0.9]),
        ("quads_replay_buffer_size", [20, 100, 200]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_sbc_boundary=0.1 --quads_cost_act_change=0.0 --quads_cost_cbf_agg=2.0 --quads_cost_no_sol=0.0 '
    # SBC
    ...
    '--quads_domain_random=True --quads_obst_density_min=0.2 --quads_obst_density_max=0.8 --quads_obst_gap_min=0.1 '
    '--quads_obst_gap_max=0.2 --quads_obst_size=0.8 '
    # Annealing
    ...
    '--wandb_group=domain_random_replay_v1'
)

_experiment = Experiment(
    "domain_random_replay_v1",
    OBSTACLE_MODEL_CLI,
