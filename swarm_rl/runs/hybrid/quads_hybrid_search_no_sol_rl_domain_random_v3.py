...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_cost_cbf_agg", [0.8]),
        ("quads_cost_no_sol", [0.0, 10.0]),
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_domain_random=True --quads_obst_density_min=0.2 --quads_obst_density_max=0.8 --quads_obst_gap_min=0.15 '
    '--quads_obst_gap_max=0.4 --quads_obst_size=0.6 '
    # Annealing
    ...
    '--wandb_group=domain_random_no_sol_v3'
)

_experiment = Experiment(
    "domain_random_no_sol_v3",
    OBSTACLE_MODEL_CLI,
