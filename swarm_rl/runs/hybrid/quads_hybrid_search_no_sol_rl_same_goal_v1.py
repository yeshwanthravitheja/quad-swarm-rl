...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    # Self
    ' --quads_mode=o_static_same_goal --quads_obs_repr=xyz_vxyz_R_omega_floor --quads_episode_duration=15.0 '
    ...
    '--wandb_group=hybrid_os_08_search_num_agents'
)

_experiment = Experiment(
    "hybrid_os_08_search_num_agents",
    OBSTACLE_MODEL_CLI,
