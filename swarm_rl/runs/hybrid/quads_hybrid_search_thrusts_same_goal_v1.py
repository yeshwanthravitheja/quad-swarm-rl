...
_params = ParamGrid(
    [
        ("seed", [0000, 3333]),
        ("quads_num_agents", [8, 32, 64]),
    ]
)

OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    # Self
    ' --quads_mode=o_static_same_goal --quads_enable_thrust=True --quads_obs_repr=xyz_vxyz_R_omega_floor '
    '--quads_episode_duration=15.0 --quads_obs_acc_his=False --quads_cost_enable_extra=True '
    '--train_for_env_steps=2000000000 '
    # Obstacle
    '--quads_obst_density=0.2 --quads_obst_size=0.8 --quads_obst_gap=0.15 '
    # Cost
    ...
    '--wandb_group=thrust_os_08_search_num_agents'
)

_experiment = Experiment(
    "thrust_os_08_search_num_agents",
    OBSTACLE_MODEL_CLI,
