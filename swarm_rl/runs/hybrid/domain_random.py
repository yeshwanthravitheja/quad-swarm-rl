...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--quads_domain_random=True --quads_obst_size_min=0.4 --quads_obst_size_max=0.8 '
    '--quads_obst_num_min=20 --quads_obst_density_max=40 '
    '--quads_obst_gap_min=0.15 --quads_obst_gap_max=0.45 '
    # Wandb
